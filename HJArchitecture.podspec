Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/jixuhui/HJArchitecture.git", :branch => "develop", :tag => "0.0.9" }
  ...
  ser.dependency 'AFNetworking', '~> 2.6.3'
  end
  ...
  s.resource = "Resources/HJArchitecture.bundle"
